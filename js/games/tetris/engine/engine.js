...
import { TIMESTEP_MS, DAS_MS, ARR_MS } from '../core/constants.js';
import { createLoop } from '../../../shared/engine/loop.js';
import { createAutoRepeat } from '../../../shared/input/autorepeat.js';
...
export function createEngine({ input, startLevel = 1 } = {}) {
  ...
  const autoRepeat = createAutoRepeat({ das: DAS_MS, arr: ARR_MS });
